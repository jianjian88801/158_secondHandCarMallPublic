				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>上牌时间：</span>
							<span class="desc">
								{{detail.shangpaishijian}}
							</span>
						</div>
																								<div class="detail-item">
							<span>行驶里程：</span>
							<span class="desc">
								{{detail.xingshilicheng}}
							</span>
						</div>
																								<div class="detail-item">
							<span>车况描述：</span>
							<span class="desc">
								{{detail.chekuangmiaoshu}}
							</span>
						</div>
																								<div class="detail-item">
							<span>用户名：</span>
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('qichepinggu','评估报价')" @click="onAcrossTap('pinggubaojia')" type="button" class="layui-btn">
								评估报价
							</button>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`qichepinggu`);
