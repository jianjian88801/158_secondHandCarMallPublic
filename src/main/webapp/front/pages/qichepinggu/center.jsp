				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="cheshenyanse" id="cheshenyanse" placeholder="车身颜色" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">上牌时间</label>
							<div class="layui-input-block">
								<input type="text" name="shangpaishijian" id="shangpaishijian" placeholder="上牌时间" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">行驶里程</label>
							<div class="layui-input-block">
								<input type="text" name="xingshilicheng" id="xingshilicheng" placeholder="行驶里程" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">车况描述</label>
							<div class="layui-input-block">
								<input type="text" name="chekuangmiaoshu" id="chekuangmiaoshu" placeholder="车况描述" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
