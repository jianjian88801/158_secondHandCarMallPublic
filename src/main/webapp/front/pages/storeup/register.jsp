          ...
          <form class="layui-form">
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 0px;">
                <input type="text" id="refid" name="refid" placeholder="请输入收藏id" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 0px;">
                <input type="text" id="tablename" name="tablename" placeholder="请输入表名" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 0px;">
                <input type="text" id="name" name="name" placeholder="请输入收藏名称" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
