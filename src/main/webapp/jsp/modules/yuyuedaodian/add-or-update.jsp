		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑预约到店</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>预约到店管理</span></li>
								<li class="breadcrumb-item active"><span>编辑预约到店</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">预约到店信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>到店时间</label>
										<div id="daodianshijianDate" class="input-append date form_datetime">
											<input id="daodianshijian-input" name="daodianshijian" size="20" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "yuyuedaodian/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("yuyuedaodian/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yuyuedaodian/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#daodianshijianDate").datetimepicker({ 
				autoclose: true,
		...
		function dataBind(){
			...
			$("#daodianshijian-input").val(ruleForm.daodianshijian);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.daodianshijian != null && res.data.daodianshijian != ''){

					$("#daodianshijian-input").val(res.data.daodianshijian);
					$('#daodianshijianFileName').val(res.data.daodianshijian)
					}
